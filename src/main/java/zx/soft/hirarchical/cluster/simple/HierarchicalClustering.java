package zx.soft.hirarchical.cluster.simple;
...
public class HierarchicalClustering {
	...
	Vector<Cluster> clusters; // keeps track of clusters
	...
	**/
	public void reportResults(FileWriter out, int numClusters, Cluster c1, Cluster c2) throws IOException {
		...
		out.write(numClusters + " " + meanInternal + " " + meanDist + " " + minDist + " " + meanHappiness + "\r");
	}
